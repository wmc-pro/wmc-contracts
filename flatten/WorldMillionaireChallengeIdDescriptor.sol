...
// Dependency file: @openzeppelin/contracts-upgradeable/access/Ownable2StepUpgradeable.sol
...
// import "contracts/interfaces/IChallenge.sol";
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    tokenId.toString(),
                    '</text><text x="21" y="216" class="B C D E G">Wins:</text><text x="57" y="216" class="B C D E">',
                    wins.toString(),
                    '</text><text x="23" y="240" class="B C D E G">Won:</text><text x="57" y="240" class="B C D E">$',
                    (won / 10 ** 18).toString(),
                    "</text></svg>"
                )
            );
